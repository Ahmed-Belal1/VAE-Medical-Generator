...
class VanillaVAE(BaseVAE):
    def __init__(
        self,
        in_channels: int,       # e.g. 1 or 3 for MedMNIST
        latent_dim: int,
        ...
        **kwargs
        ...
        # Assuming image is downsampled to 128 x 4 x 4 after 3 convs on 28x28 input
        self.last_conv_shape = (hidden_dims[-1], 4, 4)
    ...
    def decode(self, z: Tensor) -> Tensor:
        ...
        result = result.view(-1, *self.last_conv_shape)
